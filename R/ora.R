...
#'
#' @param metaboliteList A vector of FOBI metabolite identifiers that define the selected list of metabolites. Other identifiers are accepted: FOBI, HMDB, KEGG, PubChemCID, InChIKey, InChICode, and ChemSpider.
...
#' @param adjust A string indicating a multiple testing method to use. Options are: "holm", "hochberg", "hommel", "bonferroni", "BH", "BY", "fdr" and "none".
#'
#' @export
#'
#' @return A tibble with ORA result.
